...
@section('content')
    <!--================Map Area =================-->
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url({{asset('design/FrontEnd/images/about.jpg')}});">
					</div>
		...
		<section class="ftco-intro" style="background-image: url({{asset('design/FrontEnd/images/bg_3.jpg')}});" data-stellar-background-ratio="0.5">
                        ...
                        <div class="col-md-12 tab-wrap">
                            <div class="tab-content bg-light p-4 p-md-5 ftco-animate" id="v-pills-tabContent">
                                <div class="tab-pane py-2 fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
                                    <div class="row departments">
                                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                            <div class="img d-flex align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/dept-1.jpg')}});"></div>
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
                                    <div class="row departments">
                                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                            <div class="img d-flex align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/dept-2.jpg')}});"></div>
                                        </div>
                                        <div class="col-md-8">
                                ...
                                <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
                                    <div class="row departments">
                                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                            <div class="img d-flex align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/dept-3.jpg')}});"></div>
                                        </div>
                                        <div class="col-md-8">
                                ...
                                <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-day-4-tab">
                                    <div class="row departments">
                                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                            <div class="img d-flex align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/dept-4.jpg')}});"></div>
                                        </div>
                                        <div class="col-md-8">
                                ...
                                <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-day-5-tab">
                                    <div class="row departments">
                                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                            <div class="img d-flex align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/dept-5.jpg')}});"></div>
                                        </div>
                                        <div class="col-md-8">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/doc-1.jpg')}});"></div>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/doc-2.jpg')}});"></div>
							</div>
							<div class="text pt-3 text-center">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/doc-3.jpg')}});"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>Dr. Ian Smith</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('design/FrontEnd/images/doc-4.jpg')}});"></div>
							</div>
							<div class="text pt-3 text-center">
                        ...
                        <div class="carousel-testimony owl-carousel">
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url({{asset('design/FrontEnd/images/person_1.jpg')}}">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url({{asset('design/FrontEnd/images/person_2.jpg')}}">
                                    </div>
                                    <div class="text ml-2 bg-light">
                                        <span class="quote d-flex align-items-center justify-content-center">
                                        <i class="icon-quote-left"></i>
                            ...
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url({{asset('design/FrontEnd/images/person_3.jpg')}})">
                                    </div>
                                    <div class="text ml-2 bg-light">
                                        <span class="quote d-flex align-items-center justify-content-center">
                                        <i class="icon-quote-left"></i>
                            ...
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url({{asset('design/FrontEnd/images/person_4.jpg')}})">
                                    </div>
                                    <div class="text ml-2 bg-light">
                                        <span class="quote d-flex align-items-center justify-content-center">
                                        <i class="icon-quote-left"></i>
        ...
        <section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" style="background-image: url({{asset('design/FrontEnd/images/bg_3.jpg')}});" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                            ...
                            <div class="col-md-4 ftco-animate">
                                <div class="blog-entry">
                                    ...
                                    <div class="text bg-white p-4">
                                        <h3 class="heading"><a href="{{route('front.post' , $post->slug)}}">{{$post->title}}</a></h3>
                                        <p>{!! $post->description !!}</p>
                                        <div class="d-flex align-items-center mt-4">
                                            <p class="mb-0"><a href="{{route('front.post' , $post->slug)}}" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
