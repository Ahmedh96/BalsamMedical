    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-header card-header-primary text-right" style="background-color:#373a6c;">  <i class="material-icons">policy</i> @lang('lang.Create Category')</h3>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_keywords" class="form-control" placeholder="@lang('lang.Type Email')" value="{{old('email')}}">
                    </div>
